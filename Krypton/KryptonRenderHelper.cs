...
namespace Krypton
{
    ...
    public class KryptonRenderHelper
    {
        ...
        {
            //new VertexPositionTexture() //1.777777777777778
            //{
            ...
            new VertexPositionTexture()
            {
                Position = new Vector3(-1.00069f, 1.00121f, 0),
                TextureCoordinate = new Vector2(0, 0),
            },
            new VertexPositionTexture()
            {
                Position = new Vector3(1.0f, 1.00121f, 0),
                TextureCoordinate = new Vector2(1, 0),
            },
            new VertexPositionTexture()
            {
                Position = new Vector3(-1.00069f, -1.0f, 0),
                TextureCoordinate = new Vector2(0, 1),
            },
            new VertexPositionTexture()
            {
